...
- App-side adapter for prompt-shape cues used by scope/continuation helpers. Uses precomputed PromptCue outputs when available, otherwise evaluates centralized cue constants directly.
