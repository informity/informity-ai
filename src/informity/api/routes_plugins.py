...
async def update_plugin_state(plugin_id: str, request: PluginStateUpdateRequest) -> PluginInventoryResponse:
    try:
...
async def update_plugin_global_state(request: PluginGlobalStateUpdateRequest) -> PluginInventoryResponse:
    try:
