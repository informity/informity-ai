...
def build_chat_translation_prompt(
    *,
    ...
    tone_instr = TONE_INSTRUCTIONS.get(tone_key, TONE_INSTRUCTIONS['natural']).format(language=model_lang)
    system = (
    ...
    try:
        async for item in gen:
            ...
            if isinstance(item, str):
                parts.append(item)
    except Exception as exc:  # pragma: no cover - defensive wrapper mirrors translate route behavior
