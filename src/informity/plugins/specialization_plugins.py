"""Module for plugins specialization plugins."""
...
_SPECIALIZATION_STYLE_RULES: tuple[str, ...] = (
    ...
    '- Start directly with findings; avoid meta-prefaces such as "Based on..." '
    'or "According to the scenario...".\n'
    "- If evidence is limited, state uncertainty explicitly without refusing "
    "when a useful partial answer is possible.\n"
    ...
    "- If retrieved evidence is thin, provide the best useful partial answer "
    "first, then briefly note uncertainty.\n"
    "- Avoid definitive legal/medical/financial/technical conclusions unless "
    "directly supported by retrieved text.",
)
...
BUILTIN_SPECIALIZATION_PLUGIN_SPECS: tuple[SpecializationPluginSpec, ...] = (
    SpecializationPluginSpec(
        ...
        scope_guidance=(
            "Focus on financial impact, cost structure, and downside exposure "
            "using only available evidence. Avoid treating assumptions as facts."
        ),
        analysis_checklist=(
        ...
        overlay_prompt=(
            "Prioritize financial interpretation: cost structure, assumptions, "
            "pricing, budget impact, material risks, and sensitivity to "
            "uncertain inputs."
        ),
    ...
    SpecializationPluginSpec(
        ...
        name="Legal Counsel",
        description=(
            "Reads contracts and agreements carefully. Surfaces key clauses and obligations."
        ),
        ...
        scope_guidance=(
            "Focus on contractual obligations, liability allocation, "
            "enforceability signals, and dispute posture. Separate "
            "evidence-backed facts from interpretation, and avoid implying legal "
            "representation or attorney-client relationship."
        ),
        analysis_checklist=(
        ...
        output_preferences=(
            "When useful, provide a risk-severity table (high/medium/low) tied "
            "to specific evidence.",
            "Use concise headings: Findings, Risk Assessment, Open Questions, "
            "and Recommended Follow-ups.",
            "Explicitly separate evidence-backed facts from legal interpretation.",
        ),
        overlay_prompt=(
            "Prioritize legal risk identification, obligations, liabilities, "
            "jurisdiction clauses, and ambiguous terms. Distinguish facts from "
            "legal interpretation and call out uncertainty."
        ),
    ...
    SpecializationPluginSpec(
        ...
        scope_guidance=(
            "Interpret medical and health-adjacent documents carefully, "
            "distinguish observed facts from interpretation, and avoid diagnosis "
        ...
        overlay_prompt=(
            "Prioritize careful interpretation of health records, prescriptions, "
            "and insurance documents. Be precise, cautious, and explicit about "
            "uncertainty."
        ),
