...
class PluginManifest(BaseModel):
    ...
    def _validate_manifest(self) -> PluginManifest:
        ...
        for hook_point in self.hook_points:
            ...
            missing_permissions = [permission for permission in required_permissions if permission not in self.permissions]
...
def _build_inventory_item(
    *,
    ...
    enabled = bool(manifest is not None and plugin_id in enabled_plugin_ids and global_enabled and valid and compatible)
