...
# Run from repo root: ./scripts/install/install_uninstall_app.sh   or   bash scripts/install/install_uninstall_app.sh
# ==============================================================================
...
echo ""
echo "To install again, run: ./scripts/install/install_app.sh"
echo ""
