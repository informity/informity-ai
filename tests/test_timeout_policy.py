"""Test module for tests test timeout policy."""
...
def test_normalize_timeout_reason_maps_enum_values() -> None:
    """Test normalize timeout reason maps enum values."""
...
def test_normalize_timeout_reason_preserves_unknown_reason_string() -> None:
    """Test normalize timeout reason preserves unknown reason string."""
...
def test_is_terminal_timeout_reason_for_queue_wait() -> None:
    """Test is terminal timeout reason for queue wait."""
