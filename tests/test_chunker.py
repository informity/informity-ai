...
"""Test module for tests test chunker."""
...
class TestChunkText:
    ...
    def test_short_text_no_overlap_applied(self) -> None:
        ...
        """Test short text no overlap applied."""
    ...
    def test_header_only_filter_keeps_single_chunk_fallback(self) -> None:
        ...
        """Test header only filter keeps single chunk fallback."""
        text = (
