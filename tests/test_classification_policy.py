...
@pytest.mark.asyncio
async def test_classify_query_with_timing_emits_shadow_event(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    result, elapsed_ms = await classify_query_with_timing('What kind of documents do you have indexed?')
