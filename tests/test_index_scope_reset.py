"""Test module for tests test index scope reset."""
...
async def test_get_index_scope_counts_groups_by_provider_and_entity_type(
    ...
    """Test get index scope counts groups by provider and entity type."""
...
async def test_reset_index_data_scope_deletes_only_target_scope(
    ...
    """Test reset index data scope deletes only target scope."""
