"""Test module for tests test contract prompt parser."""
...
def test_extract_required_headings_supports_markdown_and_numbered_sections() -> None:
    """Test extract required headings supports markdown and numbered sections."""
    question = (
        "Output must contain:\n## Scope\n## Method\n"
...
def test_has_year_subsection_cue_detects_findings_by_year() -> None:
    """Test has year subsection cue detects findings by year."""
    assert (
        parser.has_year_subsection_cue("Provide Findings by Year across all indexed records.")
        is True
    )


def test_extract_required_years_returns_sorted_unique_years() -> None:
    """Test extract required years returns sorted unique years."""
...
def test_extract_required_headings_inline_exact_order_list_stops_before_under_clauses() -> None:
    """Test extract required headings inline exact order list stops before under clauses."""
    question = (
...
def test_extract_required_headings_inline_with_exact_headings_phrase() -> None:
    """Test extract required headings inline with exact headings phrase."""
    question = (
...
def test_extract_required_headings_supports_exactly_n_sections_phrase() -> None:
    """Test extract required headings supports exactly n sections phrase."""
    question = (
...
def test_extract_required_labels_supports_columns_and_format_cues() -> None:
    """Test extract required labels supports columns and format cues."""
    question = (
...
def test_extract_required_labels_supports_include_list_cue() -> None:
    """Test extract required labels supports include list cue."""
    question = (
...
def test_has_year_subsection_cue_does_not_trigger_on_generic_by_year_phrase() -> None:
    """Test has year subsection cue does not trigger on generic by year phrase."""
