"""Test module for tests test chat continuation helpers."""
...
def test_assistant_switch_forces_terminal_completion_state() -> None:
    """Test assistant switch forces terminal completion state."""
...
def test_is_continuation_request_supports_conversational_followups() -> None:
    """Test is continuation request supports conversational followups."""
...
def test_is_continuation_request_supports_filter_update_phrase() -> None:
    """Test is continuation request supports filter update phrase."""
...
def test_is_continuation_request_rejects_new_topic_what_about_question() -> None:
    """Test is continuation request rejects new topic what about question."""
