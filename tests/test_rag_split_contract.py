"""Test module for tests test rag split contract."""
...
async def test_generation_stream_emits_checkpoint_with_query_type_and_summary() -> None:
    """Test generation stream emits checkpoint with query type and summary."""
...
async def test_generation_stream_does_not_enforce_contract_shape_in_stream_path() -> None:
    """Test generation stream does not enforce contract shape in stream path."""
