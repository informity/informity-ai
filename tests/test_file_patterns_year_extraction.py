"""Test module for tests test file patterns year extraction."""
...
def test_extract_year_from_text_matches_embedded_year_digits() -> None:
    """Test extract year from text matches embedded year digits."""
...
def test_extract_year_prefers_filename_embedded_year_before_text_fallback() -> None:
    """Test extract year prefers filename embedded year before text fallback."""
...
def test_extract_year_ignores_longer_digit_runs() -> None:
    """Test extract year ignores longer digit runs."""
